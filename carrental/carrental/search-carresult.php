...
//Query for Listing count
              ...
              $cnt=$query->rowCount();
              ?>
              <p><span><?php echo htmlentities($cnt);?> Result</span></p>
              <ul>
                <li><a class=" text-danger" href="carguides.php">View All Cars</a></li>
              ...
              foreach($results as $result)
                {  ?>
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-9">
                          <div class="card-block px-2 m-2">
                            ...
                            <p class="card-text">
                              <p>$<?php echo htmlentities($result->price5);?> Per Day</p>
                              <p>
                                <ul>
                            ...
                            <a href="vehical-details.php?vhid=<?php echo htmlentities($result->id);?>" class="btn btn-primary">Choose <span class="angle_arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span></a>
                          </div>
                        </div>
                      </div> 
                    </div>  
                  <?php }} 
                    ...
                    {?>          <div class="col-sm-12">  
                      <?php $sql = "SELECT tblvehicles.*,groups.name,groups.idd as bid  from tblvehicles join groups on groups.idd=tblvehicles.VehiclesBrand";
                      $query = $dbh -> prepare($sql);
                      $query->execute();
                      $results=$query->fetchAll(PDO::FETCH_OBJ);
                      $cnt=1;
