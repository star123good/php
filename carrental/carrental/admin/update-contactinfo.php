...
$sql="update tblcontactusinfo set intro=:intro,workingHours=:workingHours,Address=:address,EmailId=:email,ContactNo=:contactno";
$query = $dbh->prepare($sql);
$query->bindParam(':intro',$intro,PDO::PARAM_STR);
$query->bindParam(':workingHours',$workingHours,PDO::PARAM_STR);
...
<head>
	...
	<title>Car Rental Portal | Contact Info update</title>
...
{				?>	
				...
				<div class="form-group">
												...
												<div class="col-sm-8">
													<textarea class="form-control" name="workingHours" id="workingHours" required><?php echo htmlentities($result->workingHours);?></textarea>
												</div>
											</div>
											<div class="form-group">
...
<div class="form-group">
											...
											<div class="form-group">
												...
												<div class="col-sm-8">
													<input type="text" class="form-control" value="<?php echo htmlentities($result->intro);?>" name="intro" id="intro" required>
												</div>
											</div>
<?php }} ?>
