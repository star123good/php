		...
		<div class="content-wrapper">
			<div class="container-fluid">
				...
				<div class="row">
				 ...
				 <select name="menu1" onChange="MM_jumpMenu('parent',this,0)">
                  ...
                  <option value="manage-pages.php?type=str">short time rental</option>
                  <option value="manage-pages.php?type=ltr">long time rental</option>
                  <option value="manage-pages.php?type=cr">corporate rental</option>
                  <option value="manage-pages.php?type=cs">chauffeur service</option>
                  <option value="manage-pages.php?type=ts">transfer service</option>
                </select>
												</div>
											</div>
			...
			switch($_GET['type'])
			{
				...
				case "faq" :
									...
									break;
									case "str" :
									echo "short time rental";
									break;
											case "ltr" :
									echo "long time Rental";
									break;

											case "cs" :
									echo "chauffeur service";
									break;
										case "ts" :
									echo "transfer service";
									break;
case "cr" :
									echo "corporate rental";
									break;
