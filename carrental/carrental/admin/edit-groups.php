...
$name=$_POST['name'];
		...
		$price5=$_POST['price5'];
$id=$_GET['id'];
$sql="update  groups set name=:name,price1=:price1,price2=:price2,price3=:price3,price4=:price4,price5=:price5 where id=:id";
...
<?php	
$id=$_GET['id'];
$ret="select * from groups where id=:id";
