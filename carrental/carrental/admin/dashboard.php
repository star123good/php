						...
						<div class="col-md-2">
							...
							<div class="panel panel-default">
								<div class="panel-body bk-primary text-light">
									<div class="stat-panel text-center">
										<?php 
										$sql3 ="SELECT id from extras ";
										$query3= $dbh -> prepare($sql3);
										$query3->execute();
										$results3=$query3->fetchAll(PDO::FETCH_OBJ);
										$extras=$query3->rowCount();
										?>												
										<div class="stat-panel-number h1 "><?php echo htmlentities($extras);?></div>
										<div class="stat-panel-title text-uppercase">Added Extras</div>
									</div>
								</div>
								<a href="manage-extras.php" class="block-anchor panel-footer text-center">Full Detail &nbsp; <i class="fa fa-arrow-right"></i></a>
							</div>
						</div>
						<div class="col-md-2">
							<div class="panel panel-default">
