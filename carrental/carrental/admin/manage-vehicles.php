...
<?php $sql = "SELECT tblvehicles.VehiclesTitle,groups.name,tblvehicles.PricePerDay,tblvehicles.FuelType,tblvehicles.ModelYear,tblvehicles.id from tblvehicles join groups on groups.idd=tblvehicles.VehiclesBrand";
$query = $dbh -> prepare($sql);
$query->execute();
