...
$loc1=$_SESSION['picklocation'];
$loc2=$_SESSION['droplocation'];
$date1=$_SESSION['pickupdate'];
$date2=$_SESSION['dropdate'];
$time1=$_SESSION['pickuptime'];
$time2=$_SESSION['droptime'];
$mes=$_POST['com'];
...
// the message
$mssg = "First line of text\nSecond line of text";

 

// send email
mail("vi.kartsivadze@gmail.com","My subject",$mssg);
...
<div class="carsd bg-light text-dark mb-2"  >    
          ...
          <div class="card-body"> 
            ...
            <p class="card-text"><?php echo $_SESSION['picklocation']; ?> | <?php echo $_SESSION['pickupdate']; ?> <?php echo $_SESSION['pickuptime']; ?></p> <br>
            
            <h5 class="card-title">Drop Off </h5>
            <p class="card-text"><?php echo $_SESSION['droplocation']; ?> | <?php echo $_SESSION['dropdate']; ?> <?php echo $_SESSION['droptime']; ?></p>  
...
<div class="card bg-light text-dark mb-2" style="box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">    
          ...
          <div class="card-body"> 
            ...
            <p class="card-text"><?php echo $_SESSION['dropdate']; ?> <?php echo $_SESSION['droptime']; ?></p> 
            <hr>
              <h5 class="card-title">Car</h5>
            <p class="card-text"><?php 
