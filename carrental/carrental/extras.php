...
<!--extra's space-->
<h5>Extra </h5>
<p class="bg-danger">sdasdasdd sd as</p>
<span id="carname">Please Select Car</span>
<img src="https://via.placeholder.com/5" class="mt-2" id="carimg" alt="CarImage"><br>
    ...
    foreach($results as $result)
      {  ?>
        <div class="card border text-dark">
          <div class="row">
            <div class="col-sm-3" > <img src="admin/img/vehicleimages/<?php echo htmlentities($result->Vimage1);?>" class="mh-100 p-2 img-responsive" alt="Image">
            </div>
            <div class="col-sm-9">
              <div class="card-block px-2 m-2">
                ...
                <p class="card-text">
                  ...
                  switch ($day) {
                    case "1":
                    case "2":
                    echo htmlentities($result->price1);
                    break;
                    case "3":
                    echo htmlentities($result->price2);
                    break;
                    case "4":
                    case "5":
                    case "6":
                    echo htmlentities($result->price3);
                    break;
                    case "7":
                    echo htmlentities($result->price4);
                    break;
                    default:
                    echo htmlentities($result->price5);
                  }
    ...
    <tbody>
      ...
      if($query->rowCount() > 0)
      {
        ...
        {  
          ...
          <tr>
            <th scope="row">
              <input class="extra" data-priceid="<?php echo htmlentities($result->id);?>" type="checkbox" value="<?php echo htmlentities($result->name);?>" id="defaultCheck1">
            </th>
