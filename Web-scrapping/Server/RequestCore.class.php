...
class RequestCore {
    ...
    public function prep_request() {
        ...
        //added by OSJ
        curl_setopt($curl_handle, CURLOPT_CAINFO, getcwd() . '\CAcert.pem'); //true);
        curl_setopt($curl_handle, CURLOPT_SSLVERSION, 6); //tls v1.2
...
function get_html($url)
{
    ...
    $req->add_header("Host", "data.brreg.no");
    ...
    //$req->add_header("Cookie", "session=processform=0; pstk=8F5F9BEE2D376C01B7CF2B5498B5F12D000003; aps03=lng=1&tzi=1&ct=197&cst=0&cg=0&oty=1; aaat=am=0");
    $req->set_method('GET');
    $req->debug_mode = false;
    $req->send_request();
    return $req->get_response_body();
}