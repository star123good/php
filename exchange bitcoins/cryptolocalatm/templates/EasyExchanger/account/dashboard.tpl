        ...
        <div class="container">
			<div class="row">
                            ...
                            <div class="user-panel-sidebar">
                                <div class="collapse-box">
                                    ...
                                    <div class="panel-collapse collapse in" id="MyAccount">
                                        <ul class="acc-list">
                                            <li><a class="active" href="[@url]account/dashboard"><i class="fa fa-dashboard"></i> [#lang_menu_dashboard] </a></li>
                ...
                <div class="col-sm-9 page-content">
                    ...
                    <div class="inner-box">
                        <h2 class="title-2">[#lang_pending_exchanges] </h2>
                        
						<table id="addManageTable" class="table table-striped table-responsive table-bordered add-manage-table table demo" data-filter="#filter" data-filter-text-only="true">
                                <thead>
                                <tr>
                                    <th>[#lang_direction]</th>
                                    <th data-sort-ignore="true">[#lang_details]</th>
                                    <th>[#lang_option]</th>
                                </tr>
                                </thead>
                                <tbody>
