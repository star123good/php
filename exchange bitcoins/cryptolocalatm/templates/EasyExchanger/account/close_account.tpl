        ...
        <div class="container">
			<div class="row">
                ...
                <div class="col-sm-9 page-content">
                    ...
                    <div class="inner-box">
                        <h2 class="title-2">[#lang_menu_close_account]</h2>
                        [@results]
						
						<div class="alert alert-info">
							[#lang_close_account_content_1] <strong>[#lang_close_account_content_2]</strong>?<br/>
							[#lang_close_account_content_3]
						</div>
						<form action="" method="POST">
							<input type="hidden" name="eex_close" value="yes">
							<button type="submit" class="btn btn-success" name="eex_agree">[#lang_btn_10]</button> <button type="submit" class="btn btn-danger" name="eex_cancel">[#lang_btn_11]</button>
						</form>
                    </div>
                </div>
                <!--/.page-content-->
