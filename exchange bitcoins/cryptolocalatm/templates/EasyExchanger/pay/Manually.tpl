								...
								<tbody>
									...
									<tr>
										<td colspan="2">
											...
											<form id="eex_submit_transaction">
												<div class="form-group">
													<label>[#lang_field_18]</label>
													<input type="text" class="form-control" name="transaction_id" id="transaction_id">
												</div>
												<button type="button" class="btn btn-primary btn-block" onclick="eex_submit_transaction('[@exchange_id]');">[#lang_btn_16]</button>
											</form>
										</td>
									</tr>
									<tr>
