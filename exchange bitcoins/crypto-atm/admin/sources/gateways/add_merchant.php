				...
				<div class="card">
					<div class="card-body">
						...
						function load_account_fiels(value) {
							var data_url = "requests/EEXAdmin_GatewayFields.php?gateway="+value;
							$.ajax({
								type: "GET",
								url: data_url,
								dataType: "html",
						...
						if(isset($_POST['btn_add'])) {
							...
							elseif(!is_numeric($fee)) { echo error("Please enter fee with numbers."); }
								...
								$insert = $db->query("INSERT easyex_gateways (name,currency,include_fee,extra_fee,exchange_type,fee,min_amount,max_amount,reserve,allow_send,allow_receive,default_send,default_receive,a_field_1,a_field_2,a_field_3,a_field_4,a_field_5,status,require_login,require_email_verify,require_mobile_verify,require_document_verify,additional_information) VALUES ('$name','$currency','$include_fee','$extra_fee','$exchange_type','$fee','$min_amount','$max_amount','$reserve','$allow_send','$allow_receive','$default_send','$default_receive','$a_field_1','$a_field_2','$a_field_3','$a_field_4','$a_field_5','1','$require_login','$require_email_verify','$require_mobile_verify','$require_document_verify','$additional_information')");
						...
						<form action="" method="POST">
							<div class="form-group">
								<label>Select merchant from available list</label>
